<?php
function cetakjenis_main($arg=NULL, $nama=NULL) {
	...
	if(arg(3)=='pdf'){		
		...
		drupal_set_title('Cetak Laporan Jenis');
		$output_form = drupal_get_form('cetakjenis_main_form');
		return drupal_render($output_form);// . $output;
	}		
	
}

function cetakjenis_main_form($form, &$form_state) {
...
function cetakjenis_main_form_validate($form, &$form_state) {
	//$sppno = $form_state['values']['sppno'];
		
}
	
function cetakjenis_main_form_submit($form, &$form_state) {
